        ...
        <div className="mx-auto max-w-[calc(100vw-2rem)] text-center lg:mx-0 lg:max-w-[1040px] lg:text-left">
          <h2 className="break-words text-[clamp(2.15rem,8vw,3rem)] font-medium uppercase leading-[1.05] tracking-[0.018em] text-[#F4F1FA] lg:text-[clamp(3rem,4.6vw,4.75rem)]">
            <span className="lg:hidden">
              <span className="block text-tpv-accent">STARTEN SIE</span>
              <span className="block text-tpv-accent">NOCH HEUTE</span>
              <span className="block">IHR PROJEKT</span>
              <span className="block">MIT UNS</span>
            </span>
            <span className="hidden lg:block text-tpv-accent">
              STARTEN SIE NOCH HEUTE
            </span>
            <span className="hidden lg:block">IHR PROJEKT MIT UNS</span>
          </h2>
