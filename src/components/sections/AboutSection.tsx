...
export function AboutSection() {
  return (
    ...
    >
      ...
      />
      <div
        className="pointer-events-none absolute left-[22%] top-1/2 hidden h-[38rem] w-[38rem] -translate-y-1/2 rounded-full bg-[radial-gradient(circle,rgba(249,0,255,0.18)_0%,rgba(255,54,95,0.1)_36%,transparent_70%)] blur-3xl md:block"
        aria-hidden="true"
      />
        ...
        <div className="flex justify-center lg:justify-start">
          <div className="relative aspect-square w-[min(82vw,380px)] lg:w-[clamp(460px,38vw,560px)]">
            ...
            <div className="relative h-full overflow-hidden rounded-full border border-tpv-accent/65 bg-tpv-deep shadow-[0_0_54px_rgba(255,54,95,0.22),0_30px_90px_rgba(0,0,0,0.42)]">
              <video
                className="pointer-events-none absolute left-1/2 top-1/2 h-[128%] w-auto min-w-[128%] max-w-none -translate-x-1/2 -translate-y-1/2 object-cover md:hidden"
